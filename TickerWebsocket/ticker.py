...
ACCESS_TOKEN = '01KTWJNmeN7bzdCjrPgwuZyFHySyQJP0'  # Valid Till 24 Hour
...
futures_instrument = [instrument['instrument_token'] for instrument in instruments if instrument['segment'] in ['NFO-FUT'] if instrument['name'] not in ['', ' ', None]]
stock_instrument = [instrument['instrument_token'] for instrument in instruments if instrument['segment'] in ['NSE'] if instrument['name'] not in ['', ' ', None]]
indices_instrument = [instrument['instrument_token'] for instrument in instruments if instrument['segment'] in ['INDICES'] if instrument['name'] not in ['', ' ', None]]
